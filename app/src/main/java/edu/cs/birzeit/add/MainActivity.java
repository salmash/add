...
import edu.cs.birzeit.add.Models.student;
...
public class MainActivity extends AppCompatActivity {
    ...
    student getStudentData (){
        ...
        student.setID(idTxt.getText().toString());
        student.setName(nameTxt.getText().toString());
        student.setEmail(emailTxt.getText().toString());
    ...
    private class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            Toast.makeText(MainActivity.this, "New Student record created successfully", Toast.LENGTH_LONG).show();
        }
    }
